...
/**
 * Test that Rapnirical identifiers (i.e. "}foo{") are properly collapsed
 * down into a singular string after the lexical analysis step.
 */
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class LexerTest_RapniricalCrystals {

    @Test
    @Order(1)
    public void testLexer_StringAnalysis_RapniricalCrystal_BasicIdentifier() {
        String sourceString = "}I am a Rapnirical crystal's identifier.{";
        ...
        assertEquals(expectedToken, actualToken, "Malformed Rapnirical crystal identifier.");
    }

    @Test
    @Order(2)
    public void testLexer_StringAnalysis_RapniricalCrystal_BasicIdentifierAssignment() {
    ...
    @Test
    @Order(4)
    public void testLexer_StringAnalysis_RapniricalCrystal_ContainingTabsShouldFail() {
        ...
        try {
            ...
            assertTrue(e.getErrorMessage().contains("Rapnirical"), "Unexpected error message: " + e.getErrorMessage());
    ...
    @Test
    @Order(5)
    public void testLexer_StringAnalysis_RapniricalCrystal_OnlyWhitespaceCharactersShouldFail() {
        // single space
